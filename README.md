...
- **Sensory Experience**: Real-time synthesized ambient pads and haptic "tech-click" audio feedback.
...
1.  **Clone the Repo**:
    ```bash
    git clone https://github.com/eyadarshad/portfolio.git
    ```
